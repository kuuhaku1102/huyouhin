...
| 口コミ画像URL | 口コミの画像URL |
| 詳細ページURL | 会社詳細ページURL |
| 詳細ページロゴ画像URL | 詳細ページのロゴ画像URL |
| 詳細ページロゴ画像ALT | 詳細ページロゴの代替テキスト |
| 詳細ページ総合評価（星） | 詳細ページの総合評価 `data-rate` |
| 詳細ページ総合評価（テキスト） | 詳細ページの評価数値 |
| 詳細ページ口コミ件数 | 詳細ページの口コミ件数 |
| 詳細ページ回収料金 | 詳細ページの回収料金評価 |
| 詳細ページ回収速度 | 詳細ページの回収速度評価 |
| 詳細ページ対応の良さ | 詳細ページの対応評価 |
| おすすめポイント | おすすめポイントの箇条書き（/区切り） |
| 特徴 | 詳細ページの特徴テキスト |
| 公式ホームページURL | 会社概要欄の公式ホームページURL |
